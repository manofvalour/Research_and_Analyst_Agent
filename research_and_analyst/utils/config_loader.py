...
def load_config(config_path: str | None=None)->dict:
    ...
    try:
        ...
        log.error("Eror loading configuration", error=str(e))
...
if __name__ =='__main__':
    try:
        ...
        log.info("ConfigLoader test run completed succesfully")
    
    except ResearchAnalystException as e:
        log.error("Failed to load configuration file", error = str(e))
